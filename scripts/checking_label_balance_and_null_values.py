...
df_fashion_val = pd.read_csv("/data_vault/COmparative_Study_of_Multimodal_Represenations/data/processed/fashionai/val.csv")

print("FashionAI Train label counts:\n", df_fashion_train['label'].value_counts(), "\n")
print("FashionAI Val label counts:\n", df_fashion_val['label'].value_counts(), "\n")
print("FashionAI Train missing values:\n", df_fashion_train.isnull().sum(), "\n")
print("FashionAI Val missing values:\n", df_fashion_val.isnull().sum(), "\n")

print("="*20, "MOVIELENS", "="*20)
df_ml_train = pd.read_csv("/data_vault/COmparative_Study_of_Multimodal_Represenations/data/processed/movielens/train.csv")
df_ml_val = pd.read_csv("/data_vault/COmparative_Study_of_Multimodal_Represenations/data/processed/movielens/val.csv")
df_ml_test = pd.read_csv("/data_vault/COmparative_Study_of_Multimodal_Represenations/data/processed/movielens/test.csv")
