...
RAW = Path('/data_vault/COmparative_Study_of_Multimodal_Represenations/data/raw/movielens')
PROCESSED = Path('/data_vault/COmparative_Study_of_Multimodal_Represenations/data/processed/movielens')
